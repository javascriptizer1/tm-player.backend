...
const (
	...
	PlayerService_GetListPlayers_FullMethodName = "/player.PlayerService/GetListPlayers"
)
...
type PlayerServiceClient interface {
	...
	GetListPlayers(ctx context.Context, in *GetListPlayersRequest, opts ...grpc.CallOption) (*GetListPlayersResponse, error)
}
...
func (c *playerServiceClient) GetListPlayers(ctx context.Context, in *GetListPlayersRequest, opts ...grpc.CallOption) (*GetListPlayersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetListPlayersResponse)
	err := c.cc.Invoke(ctx, PlayerService_GetListPlayers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PlayerServiceServer interface {
	...
	GetListPlayers(context.Context, *GetListPlayersRequest) (*GetListPlayersResponse, error)
...
func (UnimplementedPlayerServiceServer) GetListPlayers(context.Context, *GetListPlayersRequest) (*GetListPlayersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetListPlayers not implemented")
}
...
func _PlayerService_GetListPlayers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetListPlayersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlayerServiceServer).GetListPlayers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PlayerService_GetListPlayers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlayerServiceServer).GetListPlayers(ctx, req.(*GetListPlayersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PlayerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetListPlayers",
			Handler:    _PlayerService_GetListPlayers_Handler,
		},
	},
